...
##                                                          ##
#   Helper functions that will be used often with many files #
##                                                          ##
...
# Creates secret box for private data encryption and decryption
...
# Generates a public key with given private key
...
# Splits parts of the server record 
def splitServerRecord(record):
    splitted = record.split(',')
    return splitted

# Encrypts message for private messaging
...
# Decrypts message sent from private messaging
...
# Request helper for making requests for my peers and central server
...
##                                          ##
#   DEBUGGING PURPOSES OF HELPER FUNCTIONS   #
##                                          ##
