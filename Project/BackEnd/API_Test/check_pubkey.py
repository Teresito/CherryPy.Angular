...
req = urllib.request.Request(url + pubkey_hex_str, headers=headers)
#req = urllib.request.Request(url+pubkey_hex_str, data=bytes(json.dumps(payload), 'utf-8'), headers=headers)
